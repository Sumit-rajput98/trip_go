...
class FlightTicketBook extends StatefulWidget {
  ...
  @override
  State<FlightTicketBook> createState() => _FlightTicketBookState();
}

class _FlightTicketBookState extends State<FlightTicketBook> {
  final FlightTicketLccViewModel viewModel = FlightTicketLccViewModel();
