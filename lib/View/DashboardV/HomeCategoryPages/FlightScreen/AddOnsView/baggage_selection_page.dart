...
class _BaggageTabViewState extends State<BaggageTabView> {
  ...
  List<Baggage> _getValidBaggageList() {
    ...
    return fullList.where((item) => item.code != null && item.code!.trim().isNotEmpty && item.code != 'NoBaggage').toList();
  }
  ...
  Widget build(BuildContext context) {
    ...
    final baggageProvider = Provider.of<BaggageSelectionProvider>(context, listen: false);
                      ...
                      IconButton(
                        onPressed: () {
                          if (count > 0) {
                            ...
                            baggageProvider.removeBaggage(baggageItem);
                      ...
                      IconButton(
                        onPressed: () {
                          if (totalSelectedWeight + weight <= 15) {
                            ...
                            // Add to Provider
                            baggageProvider.addBaggage(baggageItem);
