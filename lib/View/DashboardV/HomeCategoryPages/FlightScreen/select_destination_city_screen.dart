...
class SelectDestinationCityScreen extends StatefulWidget {
  const SelectDestinationCityScreen({super.key});

  @override
  State<SelectDestinationCityScreen> createState() => _SelectDestinationCityScreenState();
}

class _SelectDestinationCityScreenState extends State<SelectDestinationCityScreen> {
