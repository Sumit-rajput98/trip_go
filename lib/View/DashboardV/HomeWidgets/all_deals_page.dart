...
class _OffersPageState extends State<OffersPage> {
  ...
  final List<Map<String, dynamic>> offerTabs = [
    {"label": "Special Offers", "icon": Icons.percent},
    {"label": "Bank Offers", "icon": Icons.account_balance},
    {"label": "Flight Offers", "icon": Icons.flight},
    {"label": "Bus Offers", "icon": Icons.directions_bus},
    {"label": "Cab Offers", "icon": Icons.local_taxi},
    {"label": "Hot Deals", "icon": Icons.local_fire_department},
  ];

  String get currentTab => offerTabs[selectedIndex]['label'];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CustomAppBar(title: "All Offers"),
      body: ListView(
