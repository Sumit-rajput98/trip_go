...
//
//     final roundTripFlightSearchModel = roundTripFlightSearchModelFromJson(jsonString);

import 'dart:convert';
class RoundTripFlightSearchRequest {
  final String origin;
...
RoundTripFlightSearchModel roundTripFlightSearchModelFromJson(String str) => RoundTripFlightSearchModel.fromJson(json.decode(str));

String roundTripFlightSearchModelToJson(RoundTripFlightSearchModel data) => json.encode(data.toJson());

class RoundTripFlightSearchModel {
  final bool? success;
  final String? message;
  final Data? data;

  RoundTripFlightSearchModel({
    this.success,
    this.message,
    this.data,
  });

  factory RoundTripFlightSearchModel.fromJson(Map<String, dynamic> json) => RoundTripFlightSearchModel(
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    srdvIdx: json["SrdvIdx"],
    traceId: json["TraceId"],
    searchResult: json["searchResult"] == null ? [] : List<List<SearchResult>>.from(json["searchResult"]!.map((x) => List<SearchResult>.from(x.map((x) => SearchResult.fromJson(x))))),
  );

  Map<String, dynamic> toJson() => {
    "SrdvIdx": srdvIdx,
    "TraceId": traceId,
    "searchResult": searchResult == null ? [] : List<dynamic>.from(searchResult!.map((x) => List<dynamic>.from(x.map((x) => x.toJson())))),
  };
}
...
class SearchResult {
  ...
  final SearchResultFareClassification? fareClassification;
  ...
  factory SearchResult.fromJson(Map<String, dynamic> json) => SearchResult(
    ...
    fareClassification: json["FareClassification"] == null ? null : SearchResultFareClassification.fromJson(json["FareClassification"]),
  );
...
class SearchResultFareClassification {
  final String? color;
  final String? type;

  SearchResultFareClassification({
    this.color,
    this.type,
  });

  factory SearchResultFareClassification.fromJson(Map<String, dynamic> json) => SearchResultFareClassification(
    color: json["Color"],
    type: json["Type"],
  );
