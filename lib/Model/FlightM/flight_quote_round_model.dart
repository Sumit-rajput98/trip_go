...
FlightQuoteRoundModel flightQuoteModelFromJson(String str) => FlightQuoteRoundModel.fromJson(json.decode(str));

String flightQuoteModelToJson(FlightQuoteRoundModel data) => json.encode(data.toJson());

class FlightQuoteRoundModel {
  final bool? success;
  ...
  factory FlightQuoteRoundModel.fromJson(Map<String, dynamic> json) => FlightQuoteRoundModel(
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    ...
    inbound: json["Inbound"] == null ? null : Inbound.fromJson(json["Inbound"]),
  );
