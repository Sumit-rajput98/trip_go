...
import 'dart:convert';
class FlightSsrLccRoundRequest {
...
FlightSsrModelRoundLcc flightSsrModelRoundLccFromJson(String str) => FlightSsrModelRoundLcc.fromJson(json.decode(str));

String flightSsrModelRoundLccToJson(FlightSsrModelRoundLcc data) => json.encode(data.toJson());

class FlightSsrModelRoundLcc {
  final bool? success;
  final String? message;
  final Data1? data1;

  FlightSsrModelRoundLcc({
    this.success,
    this.message,
    this.data1,
  });

  factory FlightSsrModelRoundLcc.fromJson(Map<String, dynamic> json) => FlightSsrModelRoundLcc(
    success: json["success"],
    message: json["message"],
    data1: json["data"] == null ? null : Data1.fromJson(json["data"]),
  );
...
class Data1 {
  ...
  factory Data1.fromJson(Map<String, dynamic> json) => Data1(
    ...
    inbound: json["Inbound"] == null ? null : Data1.fromJson(json["Inbound"]),
  );
